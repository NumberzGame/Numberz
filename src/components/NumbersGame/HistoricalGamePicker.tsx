...
import {Box, Button, FileInput, Group, Text, Select} from '@mantine/core';

import { GameID, Game, Move, GameState, CustomGameID, GradedGameID } from "../../gameCode/Classes";
...
export function HistoricalGamePicker(props: historicalGamePickerProps) {
  ...
  const historicalGames = Object.fromEntries(Array.from(props.getStoredGames()).map(
